...
function NewsCard() {
    return (
        <div className="flex overflow-x-auto lg:overflow-hidden lg:scrollbar-hide gap-4 w-full px-5">
            <div className="w-full flex ">
                <div className="flex flex-no-wrap w-full">
                    <div className="w-full mr-4">
                        <div className="w-56 lg:w-auto md:w-full">
                            <img src={newsCard} alt="News" className="bg-light-blue w-full rounded-md bg-[#E7E7FC]" />
                            <div className="mt-2">
                    ...
                    <div className="w-full mr-4">
                        <div className="w-56 lg:w-auto md:w-full">
                            <img src={newsCard} alt="News" className="w-full  rounded-md bg-[#E7E7FC]" />
                            <div className="mt-2">
                                <h1 className=" font-semibold text-lg pt-4 3xl:text-[24px]">
                                    /01/ News Technology / 03 March 2022
                                </h1>
