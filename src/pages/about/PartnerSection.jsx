...
const PartnerSection = () => {
    return (
        <div className="px-5 md:px-14 lg:px-20 xl:px-24 2xl:px-28 3xl:px-45.5">
            ...
            <h1 className="text-4.7xl font-poppins font-medium w-80 leading-12">
            ...
            <div className='mt-5 grid gap-y-3 mx-auto md:grid-cols-3 md:gap-x-3'>
                    <img src={GroupMeetngImgOne} alt="two boys and two girls standing with card boards" className="w-full h-116.25 object-cover bg-center bg-cover md:order-1 xl:h-fit xl:object-contain"/>

                    <img src={GroupMeetngImgTwo} alt="some guys sitting on tables and discussing" className="w-full h-116.25 object-cover md:col-span-2 md:order-3 xl:h-fit  xl:object-contain"/>

                    <img src={GroupMeetngImgThree} alt="some girls and boys something watching in laptop" className="w-full h-116.25 object-cover md:order-2 md:col-span-2 xl:h-fit  xl:object-contain"/>

                    <img src={GroupMeetngImgFour} alt="some people taking an meeting" className="w-full h-116.25 object-cover bg-center bg-cover  md:order-4 xl:h-fit  xl:object-contain"/>
            </div>
