    ...
    return (
        <div className="relative px-5 md:px-14 lg:px-20 xl:px-24 2xl:px-28 3xl:px-45.5 w-full py-5">
            <img
                ...
                className="absolute left-0 h-60 w-full lg:w-3/5 scale-150 bg-cover bg-center object-cover"
            />
            <div className="mt-24">
                <div
     ...
     xl:text-2.5xl 2xl:leading-10 3xl:leading-10 font-serif italic font-normal w-fit">
                ...
                <h2 className="w-4/6 text-4xl font-medium py-10 xs:text-4.7xl xs:leading-13 xs:py-4 xs:w-7/10 sm:text-5.5xl sm:w-1/2 md:w-1/3 lg:text-6xl lg:leading-14 lg:w-1/3 lg:py-4 xl:text-7xl xl:leading-20 xl:py-4 2xl:text-7.7xl 2xl:leading-24 2xl:py-7 3xl:leading-24 3xl:py-10">
                ...
                {screenSize < 768 ? (
                    ...
                    <p className="md:text-lg md:leading-6 lg:leading-6 lg:m-2 xl:text-2xl xl:leading-7 md:pr-40 2xl:leading-7 2xl:w-4/6 3xl:leading-8 3xl:w-3/5 text-slate-550 font-roboto font-normal">
