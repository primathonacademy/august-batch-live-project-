    ...
    return (
        <>
            {projectData.map((item) => {
                return (
                    <div className="pb-5 ml-2 lg:ml-0 lg:w-80 xl:w-127 2xl:m-0 3xl:w-175" key={item.id}>
                        {screenSize < 1024 ? (
                        ...
                        <p className="text-lg text-gray-475 w-60 lg:w-64 xl:w-80 2xl:text-2xl 2xl:w-96 3xl:w-110">
                            {item.discription}
                        </p>
                    </div>
                );
...
const SelectedProjects = ({ screenSize }) => {
    return (
        <div className="px-5 py-20 md:px-14  lg:px-20 lg:pt-24 xl:px-24 2xl:px-28 2xl:pt-28 3xl:px-45.5">
            <h1 className="text-4xl mb-10 w-40 xl:text-5xl xl:leading-12 2xl:text-5.7xl xl:w-60 3xl:leading-15  3xl:pl-2">
                Selected Projects
            </h1>
