...
const CoFounder = () => {
    return (
        <div className="px-5 mt-72 md:px-14 lg:px-20 xl:px-24 2xl:px-28 3xl:px-45.5">
            <div className="flex lg:gap-24 xl:gap-55 2xl:gap-75 3xl:gap-94 md:w-full">
                <div className="lg:flex w-96 md:w-110 lg:w-127 xl:w-142.4 lg:gap-3 2xl:w-175 3xl:w-192.5 h-80 3xl:h-80">
                    ...
                    <div className="w-89 md:w-101.5 lg:w-116.25 xl:w-131 2xl:w-144.5 3xl:w-159.5 h-36  lg:h-40 xl:h-40 3xl:h-40">
                        <p
                            className="2xl:text-2.5xl 3xl:text-3xl opacity-60 text-left text-slate-925 italic font-normal text-2xl  
                         font-roboto mt-1 mb-7 lg:mb-8 xl:mb-9 2xl:mb-10 3xl:mb-11 w-full">
                            ...
                            scale through fail-proof design
                        </p>
                ...
                <div className="lg:w-96 xl:w-116.25 2xl:w-142.4 3xl:w-144.5 hidden lg:block 3xl:text-left xl:ml-60 3xl:ml-110">
                    <p className="lg:text-base 3xl:text-lg 2xl:text-4 text-gray-525 3xl:leading-6 opacity-100">
                        ...
                        <br />
                        Deeper Insight - Qualitative user insights validated by
                        <br /> quantitative studies that surface hidden market gaps for your
                        <br /> next big opportunity.
                        <br /> Pioneering Innovation - First-to-market features with strong
                        <br /> business cases for maintaining your edge over the competition <br />
                        consistently.
                        <br /> Compelling Design - True-to-brand aesthetics and applied <br />
                        behavioural science that delivers industry-leading
                        <br /> differentiation.
                    </p>
                </div>
            </div>
