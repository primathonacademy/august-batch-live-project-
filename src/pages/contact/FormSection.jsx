        ...
        <div className="px-5 md:px-14 lg:px-20 xl:px-24 2xl:px-28 3xl:px-45.5 mt-40 w-full ">
            {screenSize < 1024 ? (
                <div>
                    <img
                        ...
                        alt="grid-image-form"
                        className="w-106.7 h-137 bg-transparent absolute bg-center object-cover inset-0  mt-28 "></img>
                    <div>
            ...
            <div className="flex flex-col lg:flex-row-reverse lg:gap-10 xl:gap-28 2xl:gap-36 3xl:gap-52  mt-7 justify-end  ">
                <div className="mt-40 ml-8 w-80 h-210 ">
                    ...
                    <button className="w-80 tracking-wider text-white font-medium h-20 text-center rounded-full bg-blue-500 mt-10">
                        SUBMIT
                    </button>
                </div>
                        ...
                        <div>
                         ...
                         font-roboto mt-1 mb-7 w-full">
                            ...
                            <div className="flex">
                                ...
                                <div className="mt-2">
                                    <h2 className="text-base lg:text-xl text-left text-slate-925 w-44 lg:w-56 h-9 font-medium font-poppins">
                                        Mrs. Regina Christy
                                    </h2>

                                    <p className="text-left text-slate-550 w-54 h-12 font-normal text-base lg:text-xl font-poppins opacity-100">
