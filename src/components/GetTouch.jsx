        ...
        <div className="bg-white  md:pb-16 md:px-14 lg:pb-20 xl:pb-24 xl:px-24 lg:px-20 2xl:pb-28 2xl:px-28 px-5 mt-24 3xl:px-45.5">
            <section className="flex flex-row w-full bg-blue-900 p-3 rounded-lg md:rounded-xl relative overflow-hidden">
                ...
                <div
                    ...
                    <h2 className="flex justify-center lg:justify-start items-start text-4xl lg:text-5xl xl:text-6.5xl 2xl:text-7.5xl font-poppins leading-tight lg:leading-13 xl:leading-18 2xl:leading-24 text-white font-medium w-48 lg:w-full 2xl:w-137.5">
                        Let us make it real.
                    </h2>
                </div>
