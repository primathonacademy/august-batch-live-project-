            ...
            <header className=" px-5 md:px-16 lg:px-20 xl:px-25 2xl:px-30 3xl:px-45.5 md:flex md:items-center md:justify-between  md:h-19.25  lg:h-20.5  xl:h-21.75  2xl:h-23 3xl:h-24">
                <div className="flex h-18 md:border-0 justify-between items-center">
                    <div className="flex gap-4  items-center md:gap-2 lg:gap-3 xl:gap-4 2xl:gap-4 3xl:gap-5"> 
                        <div>
                            <img src={Headerlogo} alt="header logo image" className="h-6 w-4.5 md:h-6 md:w-4 lg:h-7 lg:w-5 xl:h-7.5 xl:w-5.25 2xl:h-8 2xl:w-5.5 3xl:h-8 3xl:w-6"/>
                        </div>
                        <span >
                            <img src={Headerlogoname} alt=" header logoname image" className='md:w-32 h-5 w-36 md:h-5.25   lg:h-5.5 lg:w-39 xl:h-5.75 xl:w-41 2xl:h-6 2xl:w-43 3xl:h-6.25 3xl:w-45.5'/>
                        </span>
                    </div>
