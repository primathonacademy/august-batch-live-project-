...
const Header = () => {
    ...
    return (
        <>
            <header className="w-full sticky top-0 px-5 md:px-16 lg:px-20 xl:px-24 2xl:px-28 3xl:px-45.5 md:flex md:items-center md:justify-between md:h-20 lg:h-20 xl:h-20 2xl:h-24 3xl:h-24">
