    ...
    return (
        <div className="flex flex-col justify-center items-center w-full gap-1 xs:gap-x-2.5 xs:gap-y-2 3xl:gap-3 px-5 md:px-14 lg:px-20 xl:px-25 2xl:px-28 3xl:px-45.5 bg-gray-400 bg-transparent">
            ...
            <div className="w-full">
                ...
                <div className="w-full text-#253F9C lg:text-#FFFFFF lg:w-fit lg:bg-#253F9C text-xl xs:text-5.5 sm:text-5.5 md:text-2xl xl:text-6.5 3xl:text-7 xs:leading-7 font-medium font-serif italic lg:px-4 lg:my-4">
                    Customer Love
                </div>
            ...
            <div className="flex flex-col pt-13 pb-15">
                <div className="lg:flex items-start">
                    ...
                    <blockquote className="text-#0B1226 text-lg xs:text-2xl 2xl:text-3xl 3xl:text-4xl opacity-60 font-light italic font-roboto py-12 lg:pt-0 lg:px-10 w-11/12 xs:w-4/5 md:w-11/12 lg:w-5/6 xl:w-4/6 2xl:w-4/6 3xl:w-4/6">
                ...
                <div className="flex items-center w-60 xs:w-87.5 lg:w-112.5 xl:w-143.75 lg:ml-20 xl:ml-20">
                    ...
                    <img
                        src={profileIcon}
                        alt="profile-image"
                        className="absolute left-14 xs:left-16 lg:left-52 md:left-28 xl:left-48 3xl:left-60 xl:ml-20 w-14 h-14 xs:w-17.75 xs:h-17.75 md:w-21.5 md:h-21.5 lg:w-24 lg:h-24 xl:w-28.75 xl:h-28.75"
                    />
                    <div className="flex-1 flex-col pl-8 xs:pl-10 lg:pl-14 xl:pl-16">
                        ...
                        <p className="text-#696969 text-sm xs:text-base md:text-xl xl:text-2xl lg:leading-8.5 font-normal font-poppins">
